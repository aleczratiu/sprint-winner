...
const VoteForm = ({ firebase }) => {
    ...
    function handleAddWinner() {
        console.log(`sprints/${spritId}/teams/${teamId}/${selectedWinner}/votes`);
        firebase.database.ref(`sprints/${spritId}/teams/${teamId}/${selectedWinner}/votes`).transaction((value) => {
