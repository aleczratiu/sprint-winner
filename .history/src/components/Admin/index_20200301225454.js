...
function Admin({ firebase }) {
  ...
  const [selectedSprintTeamForVotes, selectSprintTeamForVotes] = useState({ teamId: null, sprintId });
    ...
    function getMembersVotes() {
        ...
        const reasons = [];
        console.log('==============members==============', {selectedTeam, selectedSprintTeamForVotes});
        if (selectedTeam && selectedSprintTeamForVotes) {
            firebase.database.ref(`sprints/${selectedSprintTeamForVotes}/teams/${selectedTeam}/members`).on('value', (value) => {
            ...
            sprintsList.push(
                <ListItem key={id}>
                    ...
                    <Select
                        ...
                        onChange={(event) => selectSprintTeamForVotes(event.target.value)}
                    >
                        {getSprintTeams(sprints[id].teams)}
                    </Select>
                </ListItem>
