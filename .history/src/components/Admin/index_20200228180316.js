    ...
    function getActiveSprint() {
        firebase.database.ref('activeSprint').on('value', value => {
            ...
            if (value && existentActiveSprint.status === true) {
                ...
                console.log('sprints', sprints[existentActiveSprint.sprintId].teams[existentActiveSprint.teamId].name);
                setSelectedSprintTeam(sprints[existentActiveSprint.sprintId].teams[existentActiveSprint.teamId].name)
            }
        })
    }
