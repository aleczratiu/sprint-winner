...
function Admin({ firebase }) {
  ...
  const [memberPicture, setMemberPicture] = useState();
    ...
    function getTeamMembers() {
        if (selectedTeam) {
            firebase.database.ref(`teams/${selectedTeam}/members`).once('value', (value) => {
                if (value) {
    ...
    function handleAddTeam () {
        firebase.database.ref(`teams/${selectedTeam}/members`).push().set({name: });
    }
    ...
    return (
        ...
        <TabPanel value={value} index={1}>
            ...
            <TextField id="standard-basic" label="Standard" placeholder="Name" onChange={handleTeamMember} />
            <TextField id="standard-basic" label="Standard" placeholder="Profile picture url" onChange={handleMemberPicture} />
            <Fab color="primary" aria-label="add">
                <AddIcon onClick={handleAddTeam} />
            </Fab>
        </TabPanel>
