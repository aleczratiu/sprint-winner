...
const Winners = ({ firebase }) => {
    ...
    }, [displayWinners, activeSprintObject])
    ...
    function checkIsAdmin(authUser) {
        ...
        return <button style={{ display: !isAdmin ? 'none' : 'block' }} onClick={firebase.database.ref('activeSprint').set({ ...activeSprintObject, showWinner: !activeSprintObject.showWinner })}>Show winners</button>
    }
