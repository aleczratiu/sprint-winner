...
const Winners = ({ firebase }) => {
    ...
    function checkIsAdmin(authUser) {
        ...
        return <button style={{ display: !isAdmin ? 'none' : 'block' }} onClick={firebase.database.ref('activeSprint').set({ ...activeSprintObject })}>Show winners</button>
    }
